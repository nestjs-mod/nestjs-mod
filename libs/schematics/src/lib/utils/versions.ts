...
export const nestJsModDeps = {
  '@nestjs-mod/common': '2.13.4',
  '@nestjs-mod/reports': '2.13.4',
  '@nestjs-mod/terminus': '1.12.1',
  '@nestjs-mod/pino': '1.13.1',
  '@nestjs-mod/pm2': '1.11.1'
};
export const nestJsModDevDeps = {
  '@nestjs-mod/testing': '2.13.4',
  '@nestjs-mod/schematics': '2.8.4'
};
