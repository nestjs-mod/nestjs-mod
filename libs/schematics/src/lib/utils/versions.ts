...
export const nestJsModDeps = {
  '@nestjs-mod/common': '2.5.2',
  '@nestjs-mod/reports': '2.5.2',
  '@nestjs-mod/terminus': '1.5.1',
  '@nestjs-mod/pino': '1.6.1',
  '@nestjs-mod/pm2': '1.4.1'
};
export const nestJsModDevDeps = {
  '@nestjs-mod/testing': '2.5.2',
  '@nestjs-mod/schematics': '2.1.5'
};
