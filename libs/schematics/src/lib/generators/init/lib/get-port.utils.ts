...
const getAvailablePort = async (options: { host: any; port: number }, hosts: Set<string | undefined>) => {
...
export default async function getPorts(options: { port: any; exclude?: any }) {
  let ports;
  let exclude = new Set();
