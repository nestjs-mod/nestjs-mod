...
export function ConfigModelProperty(
  options?: Omit<ConfigModelPropertyOptions, 'propertyKey' | 'originalName'>
) {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
